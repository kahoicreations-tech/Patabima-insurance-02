...
class Command(BaseCommand):
    ...
    def seed_pricing(self):
        ...
        try:
            ...
            pricing_data = [
                {'subcategory': private_tp, 'underwriter': madison, 'base_premium': 2975.00, 'effective_from': date.today()},
                {'subcategory': private_tp, 'underwriter': patabima, 'base_premium': 2975.00, 'effective_from': date.today()},
                {'subcategory': private_tp, 'underwriter': jubilee, 'base_premium': 2975.00, 'effective_from': date.today()},
                {'subcategory': private_tp, 'underwriter': uap, 'base_premium': 3500.00, 'effective_from': date.today()},
            ]
