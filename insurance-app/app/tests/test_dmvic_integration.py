...
class DMVICIntegrationTests(APITestCase):
    ...
    def setUp(self):
        ...
        # Use the standalone AllowAny DMVIC vehicle_check endpoint
        self.vehicle_check_url = reverse('dmvic-vehicle-check')
...
class DMVICServiceMockTests(APITestCase):
    ...
    def test_dmvic_search_vehicle(self, mock_request):
        ...
        # Mock API response in the common callbackObj shape
        ...
        self.assertEqual(call_kwargs['data']['VehicleRegistrationNumber'], 'KCA123A')
