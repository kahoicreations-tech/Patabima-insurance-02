...
export default function EnhancedPayment({
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      {/* Payment Options Section - kept last per UX */}
      <View style={styles.section}>
        ...
        <PaymentOptions 
          ...
          clientPhone={clientDetails?.phone || clientDetails?.phone_number}
        />

        <Text onPress={showNextSteps} style={styles.nextStepsLink}>
          Next Steps
        </Text>
      </View>
    </ScrollView>
