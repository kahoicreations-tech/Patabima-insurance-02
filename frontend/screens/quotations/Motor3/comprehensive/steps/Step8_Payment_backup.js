        ...
        const pollPaymentStatus = async () => {
          ...
          try {
            ...
            if (attempts < maxAttempts) {
              ...
              // Timeout - still pending after 60 seconds
              setIsProcessingPayment(false);
              Alert.alert(
                'Payment Timeout',
          ...
          <View style={styles.drawerContent}>
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <View style={styles.summaryCard}>
                ...
                <View style={styles.summaryRow}>
                  <Text style={styles.summaryLabelSmall}>IRA Levy (0.25%):</Text>
                  <Text style={styles.summaryValueSmall}>
                    KSh {(displayPremium?.breakdown?.itl || 0).toLocaleString()}
                  </Text>
                </View>
                
                <View style={styles.summaryRow}>
                  <Text style={styles.summaryLabelSmall}>Training Levy (0.25%):</Text>
                  <Text style={styles.summaryValueSmall}>
                    KSh {(displayPremium?.breakdown?.pcf || 0).toLocaleString()}
                  </Text>
                </View>
                
                <View style={styles.summaryRow}>
                  <Text style={styles.summaryLabelSmall}>Stamp Duty:</Text>
                  <Text style={styles.summaryValueSmall}>
                    KSh {(displayPremium?.breakdown?.stamp_duty || 40).toLocaleString()}
                  </Text>
                </View>
