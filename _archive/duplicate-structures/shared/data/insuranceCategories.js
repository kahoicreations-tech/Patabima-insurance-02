...
export const INSURANCE_CATEGORIES = [
  {
    ...
    icon: '🚗',
    image: require('../../frontend/assets/images/motor.png'),
  ...
  },
  {
    ...
    icon: '🏥',
    image: require('../../frontend/assets/images/health.png'),
  ...
  },
  {
    ...
    icon: '👷',
    image: require('../../frontend/assets/images/wiba.png'),
  ...
  },
  {
    ...
    icon: '⚰️',
    image: require('../../frontend/assets/images/funeral.png'),
  ...
  },
  {
    ...
    icon: '✈️',
    image: require('../../frontend/assets/images/travel.png'),
    color: Colors.info,
  ...
  },
  {
    ...
    icon: '🛡️',
    image: require('../../frontend/assets/images/accident.png'),
    color: Colors.primary,
    type: CATEGORY_TYPES.GENERAL,
    status: CATEGORY_STATUS.ACTIVE,
  ...
  },
  {
    ...
    icon: '💼',
    image: require('../../frontend/assets/images/professional.png'),
    color: Colors.success,
    type: CATEGORY_TYPES.COMMERCIAL,
    status: CATEGORY_STATUS.ACTIVE,
  ...
  },
  {
    ...
    icon: '🏠',
    image: require('../../frontend/assets/images/home.png'),
    color: Colors.warning,
    type: CATEGORY_TYPES.GENERAL,
    status: CATEGORY_STATUS.ACTIVE,
