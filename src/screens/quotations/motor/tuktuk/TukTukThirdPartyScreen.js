/**
 * TukTuk Third Party Insurance Screen
 * Basic third party liability coverage for three-wheeler vehicles
 */
...
function TukTukThirdPartyScreen() {
  ...
  const [calculatedPremium, setCalculatedPremium] = useState({
    annual: 25000, // Fixed third party premium for TukTuk
    monthly: 2500,
    breakdown: {
      base: 20000,
      passenger: 3000,
  ...
  const totalSteps = 4; // Personal Info, Vehicle Details, Insurer Selection, Documents
  ...
  const handleSubmit = () => {
    if (validateCurrentStep()) {
      Alert.alert(
        'Quotation Submitted',
        'Your TukTuk third party insurance quotation has been submitted successfully! We will contact you shortly.',
        [
          {
            text: 'OK',
    ...
    <SafeAreaView style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.titleContainer}>
          <Text style={styles.title}>TukTuk Third Party</Text>
      ...
      <View style={styles.coverageBanner}>
        ...
        <Text style={styles.coverageText}>
          Third Party coverage protects you against claims from other parties in case of accidents
        </Text>
      </View>
...
export default TukTukThirdPartyScreen;
