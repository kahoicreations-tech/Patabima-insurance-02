/**
 * Enhanced Motor Insurance Category Selection Screen
 * Allows users to choose vehicle category before proceeding to the quotation screen
...
// Import the enhanced vehicle categories from our data layer
import { getVehicleCategories } from '../../../data';

const EnhancedMotorCategorySelectionScreen = ({ navigation }) => {
  const insets = useSafeAreaInsets();
  const vehicleCategories = getVehicleCategories();
  
  const handleCategorySelect = (category) => {
    // Navigate to the motor quotation screen with selected category
...
export default EnhancedMotorCategorySelectionScreen;
