/**
 * PSV Third-Party Insurance Screen
 * 
 * This screen handles the PSV (Public Service Vehicle) third-party insurance 
...
// PSV types
const PSV_TYPES = [
  'Matatu', 'Bus', 'Shuttle', 'Taxi', 'Boda Boda', 'Tuk Tuk'
];

// Vehicle makes and models data (focused on PSV vehicles)
const VEHICLE_MAKES = [
  'Toyota', 'Nissan', 'Isuzu', 'Mitsubishi', 'Mercedes-Benz', 
  'Scania', 'Hino', 'Volvo', 'MAN', 'TVS', 'Bajaj'
];

const VEHICLE_MODELS = {
  'Toyota': ['Hiace', 'Coaster', 'Probox', 'Succeed', 'Vitz', 'Passo'],
  'Nissan': ['Caravan', 'Serena', 'NV200', 'Urvan'],
  'Isuzu': ['NQR', 'NPR', 'FRR', 'MV', 'NHR'],
  'Mitsubishi': ['Rosa', 'Canter', 'L300'],
  'Mercedes-Benz': ['Sprinter', 'Vito', 'Atego'],
  'Scania': ['K Series', 'F Series'],
  'Hino': ['300 Series', '500 Series'],
  'Volvo': ['B7', 'B9', 'B11'],
  'MAN': ['Lions Coach', 'Lions Intercity'],
  'TVS': ['King', 'XL Super'],
  'Bajaj': ['RE', 'Maxima']
};
...
// Routes
const COMMON_ROUTES = [
  'Nairobi CBD - Eastlands', 
  'Nairobi CBD - Westlands',
  'Nairobi CBD - Karen',
  'Nairobi CBD - Ngong Road',
  'Nairobi CBD - Thika Road',
  'Nairobi - Nakuru',
  'Nairobi - Mombasa',
  'Nairobi - Kisumu',
  'Mombasa - Malindi',
...
// SACCOS (for matatus)
const PSV_SACCOS = [
  'Super Metro', 'Metro Trans', 'KBS', 'City Hoppa', 
  'Double M', '2NK', 'Lopha', 'Mbukinya', 
  'Githurai', 'Rembo', 'Umoinner', 'Other'
];
...
// PSV third-party insurance constants
const BASE_PREMIUM = 12000; // Base premium for PSV third-party insurance
const MIN_PREMIUM = 12000; // Minimum premium allowed

export default function PSVThirdPartyScreen() {
