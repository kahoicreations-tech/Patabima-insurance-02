/**
 * Commercial Vehicle Insurance Landing Screen
 * Lists all available commercial vehicle insurance products
 */
...
const CommercialVehicleScreen = ({ navigation }) => {
  ...
  const handleProductSelect = (product) => {
    navigation.navigate(product.screen, {
      vehicleCategory: { id: 'commercial', name: 'Commercial Vehicle' },
  ...
  return (
    <SafeAreaView style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Commercial Vehicle Insurance</Text>
        <View style={{ width: 24 }} />
      </View>
      ...
      >
        <View style={styles.content}>
          ...
          <Text style={styles.subtitle}>
            Choose the appropriate insurance product for your commercial vehicle
          </Text>
          ...
          <View style={styles.infoCard}>
            <View style={styles.infoHeader}>
              ...
              <Text style={styles.infoTitle}>Commercial Vehicle Coverage</Text>
            </View>
            <Text style={styles.infoText}>
              Commercial vehicle insurance covers trucks, vans, delivery vehicles, and other business-use vehicles. Enhanced liability coverage protects your business operations.
            </Text>
          </View>
